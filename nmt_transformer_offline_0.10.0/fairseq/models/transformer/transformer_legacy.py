...
#offline
@register_model_architecture("transformer", "transformer_offline_wmt_en_de")
def transformer_offline_wmt_en_de(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 896)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_big_ts")
def transformer_vaswani_wmt_en_de_big_ts(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 1024)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 4096)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 16)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", False)
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_E6D4")
def transformer_vaswani_wmt_en_de_E6D4(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", False)
...
@register_model_architecture("transformer", "transformer_iwslt_de_en_D4")
def transformer_iwslt_de_en_D4(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 1024)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 4)
    args.encoder_layers = getattr(args, "encoder_layers", 6)
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_E4D3")
def transformer_vaswani_wmt_en_de_E4D3(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", False)
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_E6D2")
def transformer_vaswani_wmt_en_de_E6D2(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", True)
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_E6D2_hy")
def transformer_vaswani_wmt_en_de_E6D2_hy(args):
...
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_E6D2_zhbo")
def transformer_vaswani_wmt_en_de_E6D2_zhbo(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 512)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 2048)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 8)
    args.decoder_embed_dim = getattr(args, "decoder_embed_dim", 512)
...
#test 
@register_model_architecture("transformer", "transformer_vaswani_wmt_en_de_big_ts_E4D4")
def transformer_vaswani_wmt_en_de_big_ts_E4D4(args):
    args.encoder_embed_dim = getattr(args, "encoder_embed_dim", 1024)
    args.encoder_ffn_embed_dim = getattr(args, "encoder_ffn_embed_dim", 4096)
    args.encoder_attention_heads = getattr(args, "encoder_attention_heads", 16)
    args.encoder_normalize_before = getattr(args, "encoder_normalize_before", False)
